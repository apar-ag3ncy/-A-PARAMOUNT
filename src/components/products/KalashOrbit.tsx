  ...
  return (
    <div className="relative mx-auto w-full max-w-lg">
      ...
      >
        ...
        />
        {!ready && (
          <span className="absolute inset-0 flex items-center justify-center font-display text-[10px] tracking-[0.24em] text-olive/50 uppercase">
            Loading…
          </span>
        )}
        {label && (
          <span className="pointer-events-none absolute right-0 bottom-4 left-0 text-center font-display text-[10px] tracking-[0.24em] text-olive-deep/60 uppercase">
